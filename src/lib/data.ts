...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "Schedule a pickup in 60 seconds. We collect, clean with your saved preferences, and deliver back to your door — tracked live, kilometre by kilometre.",
    icon: Truck,
...
export const washFoldPricing = {
  ...
  pickupFee: 0,
  addOns: [
    { id: "hypoallergenic", label: "Hypoallergenic detergent", price: 800 },
    { id: "eco", label: "Eco-friendly detergent", price: 600 },
    { id: "softener", label: "Premium fabric softener", price: 400 },
    { id: "hang-dry", label: "Hang dry delicates", price: 1500 },
    { id: "stain", label: "Stain treatment", price: 1200 },
  ],
};

export const machinePricing = [
  { machine: "Compact Washer (8 kg)", price: 2500, duration: "28 min" },
  { machine: "Standard Washer (12 kg)", price: 3500, duration: "32 min" },
  { machine: "Large Washer (18 kg)", price: 5000, duration: "38 min" },
  { machine: "Mega Washer (25 kg)", price: 7000, duration: "42 min" },
  { machine: "Dryer (12 kg)", price: 400, duration: "per 10 min" },
  { machine: "Dryer (18 kg)", price: 600, duration: "per 10 min" },
];

export const dryCleaningPricing = [
  { item: "Shirt / Blouse", price: 2500 },
  { item: "Trousers / Skirt", price: 3000 },
  { item: "Two-piece Suit", price: 7500 },
  { item: "Dress", price: 6000 },
  { item: "Evening / Designer Dress", price: 15000 },
  { item: "Wedding Dress (clean + preserve)", price: 85000 },
  { item: "Agbada Set (3-piece)", price: 12000 },
  { item: "Aso-Oke / Gele", price: 6000 },
  { item: "Ankara Garment", price: 3000 },
  { item: "Coat / Overcoat", price: 9000 },
  { item: "Leather / Suede Jacket", price: 25000 },
  { item: "Silk Garment", price: 5500 },
  { item: "Curtains (per panel)", price: 8000 },
  { item: "Rug (per sq m)", price: 3500 },
  { item: "Shoes (pair)", price: 12000 },
  { item: "Handbag", price: 18000 },
  { item: "Duvet / Comforter", price: 12000 },
];
...
export const locations: Location[] = [
  {
    ...
    amenities: ["Free Wi-Fi", "Espresso bar", "Workspace lounge", "24/7 power backup", "Kids corner"],
    washers: { total: 24, available: 9 },
    dryers: { total: 20, available: 7 },
    parking: "Free on-site parking",
    mapQuery: "14 Admiralty Way Lekki Phase 1 Lagos",
  },
  {
    id: "victoria-island",
    name: "Lustra Victoria Island",
    address: "22B Akin Adesola Street",
    city: "Victoria Island, Lagos",
    hours: "Open 24 hours",
    phone: "+234 812 345 0002",
    amenities: ["Free Wi-Fi", "Vending café", "Study pods", "24h security", "24/7 power backup", "Package lockers"],
    washers: { total: 32, available: 14 },
    dryers: { total: 28, available: 11 },
    parking: "Dedicated lot, first hour free",
    mapQuery: "22B Akin Adesola Street Victoria Island Lagos",
  },
  {
    id: "yaba",
    name: "Lustra Yaba",
    ...
    phone: "+234 812 345 0003",
    amenities: ["Student pricing", "Free Wi-Fi", "Study pods", "Print station", "24/7 power backup"],
    washers: { total: 18, available: 4 },
    dryers: { total: 16, available: 6 },
    parking: "Street parking + campus shuttle stop",
    mapQuery: "8 Commercial Avenue Yaba Lagos",
  },
];
...
export const testimonials = [
  {
    name: "Amara Osei",
    role: "Shortlet host · 12 apartments, Lekki",
    quote:
  ...
  },
  {
    ...
    role: "Product designer & mum of three",
    quote:
  ...
  {
    name: "Tunde Adeyemi",
    role: "Graduate student, UNILAG",
    quote:
      "Student discount, a location that stays open past midnight, and I get a Telegram ping the second my dryer finishes. I study in their lounge while my laundry does itself.",
    rating: 5,
  },
  {
    name: "Zainab Bello",
    ...
    quote:
      "They cleaned and preserved my wedding dress like museum conservators — and pressed my mum's aso-oke for the traditional ceremony. The before/after photos nearly made me cry.",
    rating: 5,
  },
  {
    name: "James Okafor",
    role: "GM, The Meridian Hotel, Victoria Island",
    quote:
...
export const faqs = [
  ...
  },
  {
    ...
    a: "Every order is photographed and barcoded at intake. In the rare event of an issue, report it in-app, on WhatsApp, or to any team member within 7 days — we resolve claims within 48 hours and insure garments up to ₦500,000 per item.",
  },
  {
  ...
  },
  {
    ...
    a: "Cards and bank transfer via Paystack and Flutterwave, USSD, Apple Pay and Google Pay in the app, and your Lustra wallet balance. Commercial accounts pay by monthly invoice. Gift cards and promo codes apply at checkout.",
  },
];
...
export const posts: Post[] = [
  ...
  },
  {
    ...
    content: [
      "A 120-room hotel processes around 180,000 kilograms of linen a year. Run in-house, the true cost lands between ₦750 and ₦1,100 per kilogram once you count what most P&Ls hide — and that is before the diesel bill for keeping the machines running through outages.",
      ...
      "Outsourced linen programs at volume run ₦550–₦800 per kilogram with SLA-backed turnaround, and convert a fixed cost — including the generator fuel line nobody attributes to laundry — into a variable one that scales with occupancy.",
  ...
  },
  {
    ...
    excerpt:
      "Triple par stock, sealed turnover kits, and same-day SLAs — the linen operations system used by Lagos's top-rated shortlet hosts.",
    category: "Business Laundry",
    readMinutes: 8,
    date: "2026-03-02",
    author: "Marcus Hale, VP Commercial",
...
export const jobs = [
  ...
  {
    id: "couture-cleaner",
    title: "Couture & Traditional Attire Artisan",
    type: "Full-time",
    location: "Lagos (Lekki)",
    salary: "₦250k–₦400k/mo",
    blurb: "Wedding dresses, designer garments, aso-oke, lace and leather. The most skilled hands in the building work in our couture studio.",
  },
  {
  ...
  },
  {
    ...
    type: "Full-time",
    location: "Lagos",
    salary: "₦300k–₦450k/mo + commission",
